{{-- Enhanced Course Application Form --}}
<form action="{{ route('courses.apply', $course->id) }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <h2 class="text-2xl font-bold mb-2">Apply for {{ $course->title }}</h2>
