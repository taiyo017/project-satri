...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p>Career Application Communication</p>
        </div>
        ...
        <div class="email-body">
            ...
            <div class="info-box">
                <div class="info-box-title">Regarding Position</div>
                <div class="info-box-content">{{ $careerTitle }}</div>
            </div>
            ...
            <div class="signature">
                <p>Best regards,</p>
                <p class="company-name">{{ config('app.name') }} Recruitment Team</p>
            </div>
