    ...
    <div class="space-y-6">
        ...
        <div class="rounded-xl border p-6 mb-6"
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    <h4 class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2">📱 Quick Start Guide</h4>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mb-3">
                        Fill in the basic app information below. After creating the app, you'll be able to add versions, files, screenshots, and generate QR codes from the app detail page.
                    </p>
                    <div class="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <span class="inline-flex items-center gap-1 px-2 py-1 rounded bg-white/50 dark:bg-gray-800/50">
                        ...
                        <span class="text-gray-500">Step 2: Add Versions & Files</span>
                        <span class="text-gray-400">→</span>
                        <span class="text-gray-500">Step 3: Upload Screenshots</span>
                        <span class="text-gray-400">→</span>
                        <span class="text-gray-500">Step 4: Generate QR Code</span>
                    </div>
                </div>
            </div>
        </div>

        <form action="{{ route('apps.store') }}" method="POST" enctype="multipart/form-data" x-data="appForm()">
            @csrf
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <x-text-input id="name" type="text" name="name" class="mt-2 block w-full"
                                    :value="old('name')" x-model="name" @input="generateSlug" required />
                            ...
                            <div>
                                ...
                                <div class="relative mt-2">
                                    <x-text-input id="slug" type="text" name="slug" class="block w-full pr-28"
                                        :value="old('slug')" x-model="slug" required />
                            ...
                            <div>
                                ...
                                <select id="app_category_id" name="app_category_id"
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('app_category_id') == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="package_name" name="package_name" type="text" class="mt-2 block w-full"
                                    :value="old('package_name')" placeholder="com.example.app" />
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="8"
                                    ...
                                    placeholder="Detailed app description">{{ old('description') }}</textarea>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="pt-4 space-y-3">
                                ...
                                <p class="text-xs text-center text-gray-500 dark:text-gray-400">
                                    After creating, you'll add versions, files & screenshots
                                </p>
                            ...
                            <div class="flex flex-col items-center">
                                <div class="mb-4 w-full">
                                    <div id="icon-placeholder"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <span class="text-gray-500 dark:text-gray-400 text-sm">No icon selected</span>
                                        </div>
                                    </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400 text-center">
                                        PNG, JPG up to 2MB (512x512 recommended)
                                    </p>
