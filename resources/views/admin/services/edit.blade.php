<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <form action="{{ route('services.update', $service) }}" method="POST" enctype="multipart/form-data"
            x-data="serviceForm('{{ $service->title }}', '{{ $service->slug }}')">
            @csrf
            @method('PUT')
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <x-text-input id="title" type="text" name="title" class="mt-2 block w-full"
                                    :value="old('title', $service->title)" x-model="title" @input="generateSlug"
                            ...
                            <div>
                                ...
                                <div class="relative mt-2">
                                    <x-text-input id="slug" type="text" name="slug"
                                        class="block w-full pr-28" :value="old('slug', $service->slug)" x-model="slug"
                            ...
                            <div>
                                ...
                                <textarea id="short_description" name="short_description" rows="3"
                                    ...
                                    placeholder="A brief summary that will appear in listings">{{ old('short_description', $service->short_description) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="12"
                                    ...
                                    placeholder="Provide detailed information about this service">{{ old('description', $service->description) }}</textarea>
                                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <div>
                                ...
                                <x-text-input id="icon" name="icon" type="text" class="mt-2 block w-full"
                                    :value="old('icon', $service->icon)" placeholder="e.g., fa-solid fa-code, lucide-laptop" />
                                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <div class="p-6">
                            <div class="flex flex-col items-center">
                                <div class="mb-4 w-full">
                                    @if ($service->image)
                                        <img src="{{ asset('storage/' . $service->image) }}" id="image-preview"
                                ...
                                <div class="w-full">
                                    <label for="image"
                                        ...
                                        <span>{{ $service->image ? 'Change Image' : 'Choose Image' }}</span>
                                    </label>
    ...
    @push('scripts')
        <script>
            function serviceForm(initialTitle = '', initialSlug = '') {
                return {
                    title: initialTitle,
                    slug: initialSlug,
                    generateSlug() {
