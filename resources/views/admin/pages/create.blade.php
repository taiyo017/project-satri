<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <form action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data" x-data="pageForm()">
            @csrf
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <x-text-input id="subtitle" type="text" name="subtitle" class="mt-2 block w-full"
                                    :value="old('subtitle')" placeholder="Optional subtitle for the page" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="meta_keywords" type="text" name="meta_keywords"
                                        class="mt-2 block w-full" :value="old('meta_keywords')"
                                ...
                                <div>
                                    ...
                                    <x-text-input id="canonical_url" type="text" name="canonical_url"
                                        class="mt-2 block w-full" :value="old('canonical_url')"
