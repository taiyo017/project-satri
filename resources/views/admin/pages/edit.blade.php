        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Editing: <span class="font-semibold text-gray-700 dark:text-gray-300">{{ $page->title }}</span>
                </p>
            </div>
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <x-text-input id="title" type="text" name="title" class="mt-2 block w-full"
                                    :value="old('title', $page->title)" x-model="title" @input="generateSlug"
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                                    Unique URL identifier (e.g., about-us)
                                </p>
                            ...
                            <div>
                                ...
                                <x-text-input id="subtitle" type="text" name="subtitle" class="mt-2 block w-full"
                                    :value="old('subtitle', $page->subtitle)" placeholder="Optional subtitle for the page" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="md:col-span-2">
                                    ...
                                    <x-text-input id="meta_title" type="text" name="meta_title"
                                        class="mt-2 block w-full" :value="old('meta_title', $page->meta_title)" maxlength="60"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="meta_description" name="meta_description" rows="3" maxlength="160"
                                        ...
                                        placeholder="Brief description for search engines (120-160 characters)">{{ old('meta_description', $page->meta_description) }}</textarea>
                                ...
                                <div>
                                    <x-input-label for="meta_keywords" :value="__('Meta Keywords')"
                                        class="text-gray-700 dark:text-gray-300" />
                                    <x-text-input id="meta_keywords" type="text" name="meta_keywords"
                                        class="mt-2 block w-full" :value="old('meta_keywords', $page->meta_keywords)"
                                ...
                                <div>
                                    <x-input-label for="canonical_url" :value="__('Canonical URL')"
                                        class="text-gray-700 dark:text-gray-300" />
                                    <x-text-input id="canonical_url" type="text" name="canonical_url"
                                        class="mt-2 block w-full" :value="old('canonical_url', $page->canonical_url)"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <x-text-input id="og_title" type="text" name="og_title"
                                            class="mt-2 block w-full" :value="old('og_title', $page->og_title)"
                                    ...
                                    <div>
                                        ...
                                        @if ($page->og_image)
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Current:
                                                {{ basename($page->og_image) }}</p>
                                        @endif
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea id="og_description" name="og_description" rows="2"
                                            class="mt-2 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm resize-none"
                                            placeholder="Description for social media sharing">{{ old('og_description', $page->og_description) }}</textarea>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <x-text-input id="twitter_title" type="text" name="twitter_title"
                                            class="mt-2 block w-full" :value="old('twitter_title', $page->twitter_title)"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea id="twitter_description" name="twitter_description" rows="2"
                                            class="mt-2 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-lg shadow-sm resize-none"
                                            placeholder="Description for Twitter sharing">{{ old('twitter_description', $page->twitter_description) }}</textarea>
                            ...
                            <div class="flex flex-col items-center">
                                <div class="mb-4 w-full">
                                    @if ($page->featured_image)
                                        <img id="image-preview" src="{{ asset('storage/' . $page->featured_image) }}"
                                            class="w-full h-48 object-cover rounded-xl border-2 border-gray-200 dark:border-gray-700"
                                            alt="Featured Image">
                                        <div id="image-placeholder"
                                            class="hidden w-full h-48 flex items-center justify-center bg-gray-100 dark:bg-gray-900 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600">
                                ...
                                <div class="w-full">
                                    <label for="featured_image"
                                        ...
                                        <span>{{ $page->featured_image ? 'Change Image' : 'Choose Image' }}</span>
                                    </label>
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-3">
                            <a href="{{ route('pages.show', $page) }}"
                                class="w-full flex items-center gap-3 px-4 py-3 bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-300 font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                <svg class="w-5 h-5" style="color: #1363C6;" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span
                                    class="font-medium text-gray-900 dark:text-gray-100">{{ $page->created_at->format('M d, Y') }}</span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Last Updated</span>
                                <span
                                    class="font-medium text-gray-900 dark:text-gray-100">{{ $page->updated_at->format('M d, Y') }}</span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Status</span>
                                @if ($page->status === 'published')
                                    <span
                                        class="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-medium">
                                        <span class="w-1.5 h-1.5 bg-green-500 rounded-full"></span>
                                        Published
                                    </span>
                                @else
                                    <span
                                        class="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 text-xs font-medium">
                            ...
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span
                                    class="font-medium text-gray-900 dark:text-gray-100">{{ $page->sections->count() ?? 0 }}</span>
                            </div>
                        </div>
                    </div>
