            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $contacts->total() }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600 dark:text-purple-400 mt-1">
                            {{ $contacts->filter(function ($contact) {return $contact->created_at->isToday();})->count() }}
                        </p>
                    </div>
