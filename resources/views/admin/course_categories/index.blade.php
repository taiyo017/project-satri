        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden"
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/50">
                <div class="flex flex-col gap-4">
                    ...
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('course-categories.index') }}" class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                                ...
                                <td class="px-6 py-4">
                                    @if ($category->courses->count() > 0)
                                        <span
                                            ...
                                            {{ Str::plural('course', $category->courses->count()) }}
                                        </span>
                                    @else
                                        <span
