<x-app-layout>
    <div class="space-y-4" x-data="{
        ...
        submitForward() {
            ...
            if (form) {
                form.action = '/course-applications/' + this.applicationId + '/forward-email';
                form.submit();
            }
        },
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        @if ($course->price)
                            <span
                                ...
                                NPR.{{ number_format($course->price, 2) }}
                            </span>
                        @endif
                        @if ($course->duration)
                            <span
        ...
        <div class="flex flex-row gap-6 h-[75vh]">
            ...
            <div x-show="selectedApp" x-transition:enter="transition ease-out duration-300"
        ...
        @if ($applications->isNotEmpty())
            <x-forward-course-email :course="$course" :application="$applications->first()" />
        @endif
